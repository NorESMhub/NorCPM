...
CASENAME=norcpm2a_tro10Atl5m_ng2l1dA_dtrend
...
## sst nudge setting
export ADD_SSTNUDGEPATH=/cluster/projects/nn9039k/people/pgchiu/NorCPM_togit/rewritted/sst_nudge/AMIP_SST_detrend
