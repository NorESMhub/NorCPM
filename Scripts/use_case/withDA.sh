...
# Default variables below.  # Do not modify. Override them by assign value at upper.
# experiment settings
...
: ${CASESROOT:="$WORK/norcpm_cases"}  ## case root
: ${EXESROOT:="$WORK/noresm/"}        ## bld root
: ${ARCHIVESROOT:="$WORK/archive"}    ## short term archive root
