...
export ADD_NUGPATH='/cluster/projects/nn9039k/people/ach051/nudging_files/clim/VARNAME_daily_clim_DDD.nc'
## Nudge coefficient at every time step
## 3600 sec per 1 time step, restoring time scale of 1 day is 0.041667
export ADD_NUGCOEFF=0.020834
