...
================================
-SM_DA 
-run_SM_DA.sh (shell script for temporarily setting environment variables and executing 
               the application)
   -to run the shell script, type
   
       ./run_SM_DA.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2022b, run the shell script as:
       ...
       ./run_SM_DA.sh /mathworks/home/application/R2022b
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_SM_DA.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/R2022b/runtime/glnxa64:MR/R2022b/bin/glnxa64:MR/R2022b/sys/os/glnxa64:MR/R2022b/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_SM_DA.sh 
