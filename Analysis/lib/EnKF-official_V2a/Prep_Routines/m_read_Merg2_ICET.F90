 module m_read_Merg2_ICET

contains

  subroutine read_Merg2_ICET(fname,data,modlon,modlat,depths,dlon,dlat,nrobs)
  use mod_measurement
  use mod_grid
  use nfw_mod
...
end subroutine read_Merg2_ICET
end module m_read_Merg2_ICET
