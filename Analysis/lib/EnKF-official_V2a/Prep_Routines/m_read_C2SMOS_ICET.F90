 module m_read_C2SMOS_ICET

contains

  subroutine read_C2SMOS_ICET(fname,data,modlon,modlat,depths,dlon,dlat,nrobs)
  use mod_measurement
  use mod_grid
  use nfw_mod
...
! Read  observation file
  ...
  call nfw_inq_varid(fname, ncid,'ana', vSIT_ID)
...
!Read the monthly mean 
  ...
  call nfw_inq_varid('mean_obs.nc', ncid,'ana', vSIT_ID)
...
end subroutine read_C2SMOS_ICET
end module m_read_C2SMOS_ICET
