...
!
!  modified: 05/09/2017 by Madlen Kimmritz
! Last modified: 13/07/2020 by F Counillon (MPI)
!                
!
...
!      write(cmem,'(i3.3)') imem
      ...
      print *,'"fixenkf" -- A crude routine to correct restart files obvious errors and complete diagnostic variable'
      print *
      print *,'usage: '
      print *,'   fixenkf ensemble_size'
      print *,'ex:   mpirun -n 30 ./fixenkf_cice  30'
      call exit(1)
   endif
