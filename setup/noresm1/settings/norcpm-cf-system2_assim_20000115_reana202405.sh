...
: ${RES:=f19_g16}
: ${START_DATE:=2024-03-15} # YYYY-MM-DD 
...
: ${REF_DATES:=2024-03-15} # multiple reference dates only for RUN_TYPE=hybrid
...
: ${ODA_START:=20000101}
: ${ODA_END:=20991231}
: ${ASSIMROOT:=$SETUPROOT/../../assim/enkf_cf-system2}
: ${MEAN_MOD_DIR:=$INPUTDATA/enkf/$RES/norcpm-cf-system2}
