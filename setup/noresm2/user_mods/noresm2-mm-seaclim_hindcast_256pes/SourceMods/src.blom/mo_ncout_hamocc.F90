...
contains
  ...
  subroutine truncbgc(pos,max_err,sfc,offs)

  use mod_dia,    only: trunc
  use mo_bgcmean, only: bgcm3dlvl 

  integer :: pos 
  real (kind=8) :: max_err,sfc,offs 

  if (pos > 0) call trunc(bgcm3dlvl(:,:,:,pos),max_err,sfc,offs)

  end subroutine truncbgc 
...
#ifdef SEACLIM
    use mod_dia,        only: diafnm,sigmar1,iotype,ddm,depthslev,depthslev_bnds,trunc
#else
...
#ifdef SEACLIM
                              jatmco2,jatmn2,jatmo2,srf_atmo2,srf_atmn2,bgcm3dlvl,GLB_DOMAIN 
#else
...
#ifdef SEACLIM
           &   diagfq_bgc(iogrp)/real(nstep_in_day),                            &
#endif 
...
#ifdef SEACLIM 
! --- trim precision
    call truncbgc(jlvldic(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvlalkali(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvlphosph(iogrp),0.,rnacc*1e3,1e-6) 
    call truncbgc(jlvloxygen(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvlano3(iogrp),0.,rnacc*1e3,1e-5) 
    call truncbgc(jlvlsilica(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvldoc(iogrp),0.,rnacc*1e3,1e-5) 
    call truncbgc(jlvlphyto(iogrp),0.,rnacc*1e3,1e-8) 
    call truncbgc(jlvlgrazer(iogrp),0.,rnacc*1e3,1e-8) 
    call truncbgc(jlvlpoc(iogrp),0.,rnacc*1e3,0.) 
    call truncbgc(jlvlcalc(iogrp),0.,rnacc*1e3,1e-8) 
    call truncbgc(jlvlopal(iogrp),0.,rnacc*1e3,1e-8) 
    call truncbgc(jlvliron(iogrp),0.,rnacc*1e3,1e-9) 
    call truncbgc(jlvlphosy(iogrp),0.,rnacc*1e3/dtbgc,0.) 
    call truncbgc(jlvlco3(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvlph(iogrp),0.,-1.,0.0001) 
    call truncbgc(jlvlomegaa(iogrp),0.,rnacc,0.001) 
    call truncbgc(jlvlomegac(iogrp),0.,rnacc,0.001) 
    call truncbgc(jlvln2o(iogrp),0.,rnacc*1e3,1e-8) 
    call truncbgc(jlvlprefo2(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvlo2sat(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvlprefpo4(iogrp),0.,rnacc*1e3,1e-7) 
    call truncbgc(jlvlprefalk(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvlprefdic(iogrp),0.,rnacc*1e3,0.0001) 
    call truncbgc(jlvldicsat(iogrp),0.,rnacc*1e3,0.0001) 
#endif

    ! --- Mask sea floor in level data
    call msklvl(jlvlphyto(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlgrazer(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvldoc(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlphosy(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlphosph(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvloxygen(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvliron(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlano3(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlalkali(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlsilica(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvldic(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlpoc(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlcalc(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlopal(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlco3(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlph(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlomegaa(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlomegac(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvln2o(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlprefo2(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlo2sat(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlprefpo4(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlprefalk(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvlprefdic(iogrp),depths,GLB_DOMAIN(iogrp))
    call msklvl(jlvldicsat(iogrp),depths,GLB_DOMAIN(iogrp))
    if (use_cisonew) then
      call msklvl(jlvldic13(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvldic14(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvld13c(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvld14c(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlbigd14c(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlpoc13(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvldoc13(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlcalc13(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlphyto13(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlgrazer13(iogrp),depths,GLB_DOMAIN(iogrp))
    endif
    if (use_AGG) then
      call msklvl(jlvlnos(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlwphy(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlwnos(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvleps(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlasize(iogrp),depths,GLB_DOMAIN(iogrp))
    endif
    if (use_CFC) then
      call msklvl(jlvlcfc11(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlcfc12(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlsf6(iogrp),depths,GLB_DOMAIN(iogrp))
    endif
    if (use_natDIC) then
      call msklvl(jlvlnatalkali(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlnatdic(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlnatcalc(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlnatco3(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlnatph(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlnatomegaa(iogrp),depths,GLB_DOMAIN(iogrp))
      call msklvl(jlvlnatomegac(iogrp),depths,GLB_DOMAIN(iogrp))
    endif
    if (use_BROMO) then
      call msklvl(jlvlbromo(iogrp),depths,GLB_DOMAIN(iogrp))
    endif
...
#ifdef SEACLIM 
    call wrtlvl(jlvldic(iogrp),      LVL_DIC(iogrp),      1.,      0.,cmpflg,'dissiclvl')
    call wrtlvl(jlvlalkali(iogrp),   LVL_ALKALI(iogrp),   1.,      0.,cmpflg,'talklvl')
    call wrtlvl(jlvlphosph(iogrp),   LVL_PHOSPH(iogrp),   1.,      0.,cmpflg,'po4lvl')
    call wrtlvl(jlvloxygen(iogrp),   LVL_OXYGEN(iogrp),   1.,      0.,cmpflg,'o2lvl')
    call wrtlvl(jlvlano3(iogrp),     LVL_ANO3(iogrp),     1.,      0.,cmpflg,'no3lvl')
    call wrtlvl(jlvlsilica(iogrp),   LVL_SILICA(iogrp),   1.,      0.,cmpflg,'silvl')
    call wrtlvl(jlvldoc(iogrp),      LVL_DOC(iogrp),      1.,      0.,cmpflg,'dissoclvl')
    call wrtlvl(jlvlphyto(iogrp),    LVL_PHYTO(iogrp),    1.,      0.,cmpflg,'phyclvl')
    call wrtlvl(jlvlgrazer(iogrp),   LVL_GRAZER(iogrp),   1.,      0.,cmpflg,'zooclvl')
    call wrtlvl(jlvlpoc(iogrp),      LVL_POC(iogrp),      1.,      0.,cmpflg,'detoclvl')
    call wrtlvl(jlvlcalc(iogrp),     LVL_CALC(iogrp),     1.,      0.,cmpflg,'calclvl')
    call wrtlvl(jlvlopal(iogrp),     LVL_OPAL(iogrp),     1.,      0.,cmpflg,'opallvl')
    call wrtlvl(jlvliron(iogrp),     LVL_IRON(iogrp),     1.,      0.,cmpflg,'dfelvl')
    call wrtlvl(jlvlphosy(iogrp),    LVL_PHOSY(iogrp),    1.,      0.,cmpflg,'pplvl')
    call wrtlvl(jlvlco3(iogrp),      LVL_CO3(iogrp),      1.,      0.,cmpflg,'co3lvl')
    call wrtlvl(jlvlph(iogrp),       LVL_PH(iogrp),       1.,      0.,cmpflg,'phlvl')
    call wrtlvl(jlvlomegaa(iogrp),   LVL_OMEGAA(iogrp),   1.,      0.,cmpflg,'omegaalvl')
    call wrtlvl(jlvlomegac(iogrp),   LVL_OMEGAC(iogrp),   1.,      0.,cmpflg,'omegaclvl')
    call wrtlvl(jlvln2o(iogrp),      LVL_N2O(iogrp),      1.,      0.,cmpflg,'n2olvl')
    call wrtlvl(jlvlprefo2(iogrp),   LVL_PREFO2(iogrp),   1.,      0.,cmpflg,'p_o2lvl')
    call wrtlvl(jlvlo2sat(iogrp),    LVL_O2SAT(iogrp),    1.,      0.,cmpflg,'satoxylvl')
    call wrtlvl(jlvlprefpo4(iogrp),  LVL_PREFPO4(iogrp),  1.,      0.,cmpflg,'p_po4lvl')
    call wrtlvl(jlvlprefalk(iogrp),  LVL_PREFALK(iogrp),  1.,      0.,cmpflg,'p_talklvl')
    call wrtlvl(jlvlprefdic(iogrp),  LVL_PREFDIC(iogrp),  1.,      0.,cmpflg,'p_diclvl')
    call wrtlvl(jlvldicsat(iogrp),   LVL_DICSAT(iogrp),   1.,      0.,cmpflg,'sat_diclvl')
#else
