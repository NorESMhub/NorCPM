...
# experiment settings
: ${EXPERIMENT:=noresm2-lm_dcpp-c-alstephfx} # case prefix, not including _YYYYMMDD_memXX suffix 
: ${MEMBER1:=1} # first member  
: ${ENSSIZE:=10} # number of members 
: ${COMPSET:=N1850frc2}
: ${USER_MODS_DIR:=$SETUPROOT/user_mods/noresm2-lm_dcpp-c-alstephfx_128pes}   
: ${RES:=f19_tn14}
